  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div  className='flex flex-row items-stretch justify-between px-4 md:px-8 lg:px-24 mt-4 mb-2 gap-4 md:gap-6 lg:gap-8 min-h-[300px]'>
        <div style={{ fontFamily: "'Halant', sans-serif" }} className='hidden lg:flex flex-col justify-end items-start'>
            <button 
              onClick={onBack}
            ...
            <img src="/images/Cam4.svg" className='w-20 md:w-24'/>
        </div>
        <div style={{ fontFamily: "'Instrument Sans', sans-serif" }} className='flex flex-col items-center justify-center flex-1 max-w-3xl'>
            ...
            <div className='flex flex-col lg:flex-row gap-4 md:gap-6 lg:gap-8 items-center w-full'>
                <img className='flex h-48 w-40 md:h-56 md:w-48 lg:h-64 lg:w-56 object-cover' src="/images/pic1.svg" />
                <div className='flex flex-col items-start justify-start pt-2 md:pt-4 lg:pr-8 flex-1 px-4 lg:px-0'>
                    <p className='text-xs md:text-sm lg:text-base mb-2'>Who says films are just an escape?</p>
                    <p className='text-xs md:text-sm lg:text-base leading-relaxed mb-2'>We see them as a way to live many lives - to feel, to explore, and to tell stories that stay. And with each film, we carry new memories and new reasons to keep creating.</p>
            ...
            <div style={{ fontFamily: "'Instrument Sans', sans-serif" }}  className='flex flex-col items-center justify-center mt-4 md:mt-6'>
        ...
        <div className='hidden lg:flex flex-col justify-between items-end'>
            <img src="/images/Cam1.svg" className='w-16 md:w-20'/>
            <img src="/images/Cam2.svg" className='w-20 md:w-24 mr-auto'/>
            <img src="/images/Cam3.svg" className='w-16 md:w-20'/>
        </div>
      </div>
